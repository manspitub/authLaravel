<x-app-layout>
    <div class="flex justify-center items-center min-h-screen">
        <div
            ...
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{__('Id')}}: {{ $client->id }}

            </h2>

            <dl class="space-y-4">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">{{__('Client')}}: {{ $client->name }}
                    {{$client->surname}}
                    ...
                    <div class="grid grid-cols-3 items-center">
                        ...
                        <dd class="col-span-2 text-lg font-semibold text-gray-900 dark:text-white">{{ $client->email }}
                        </dd>
                    </div>
                    <div class="grid grid-cols-3 items-center">
                        <dt class="text-gray-500 dark:text-gray-400">{{__('Age')}}:</dt>
                        <dd class="col-span-2 text-lg font-semibold text-gray-900 dark:text-white">{{ $client->age }}
                        </dd>
                    </div>
            </dl>
